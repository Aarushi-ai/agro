...
export default function LoaderScreen() {
  ...
  const leaves = [
    ...
    { left: 15, delay: 0.8, dur: 4.8, size: 16, hue: "#c49a1a", drift: -30 },
    { left: 23, delay: 1.5, dur: 6.0, size: 28, hue: "#4a5e2a", drift: 60 },
    { left: 31, delay: 0.3, dur: 5.5, size: 18, hue: "#2d5016", drift: -50 },
    { left: 42, delay: 1.1, dur: 4.5, size: 24, hue: "#8b6410", drift: 35 },
    { left: 50, delay: 2.0, dur: 5.8, size: 20, hue: "#4a5e2a", drift: -40 },
    { left: 58, delay: 0.6, dur: 6.2, size: 26, hue: "#2d5016", drift: 55 },
    { left: 67, delay: 1.8, dur: 5.0, size: 17, hue: "#c49a1a", drift: -25 },
    { left: 75, delay: 0.4, dur: 4.7, size: 23, hue: "#4a5e2a", drift: 45 },
    { left: 83, delay: 1.3, dur: 5.5, size: 19, hue: "#2d5016", drift: -60 },
    { left: 90, delay: 0.9, dur: 6.0, size: 25, hue: "#8b6410", drift: 30 },
    { left: 5, delay: 2.2, dur: 5.3, size: 21, hue: "#4a5e2a", drift: -35 },
  ];
        ...
        >
          ...
          >
            <div
              style={{
                height: "100%",
                background: "linear-gradient(90deg, #2d5016, #c49a1a)",
                borderRadius: "999px",
